	...
	<div class="row justify-content-center" id="content-container">
		<div class="col">
			<div class="row" style="margin-bottom: 3em">
				<div class="col">
					<h2>Articles tagged with "<?=ucfirst($category	)?>"</h2>
				</div>
			</div>
			<div class="row">
				<div class="col col-lg-8">
									...
									<div class='col'>
										...
										<div class='row'>
											...
											<div class='col comments-container hidden-sm-down'>
												<i class='fa fa-commenting'></i> <div class='comment-count'>".$block['comment_nr']."</div>
					...
					<?php
						...
						echo "
							<ul class='pagination justify-content-center' style='margin-top: 2em'>
								<li class='page-item ".$previousLock."'>
									<a class='page-link' href='categories.php?category=$category&page=".$previousPage."' tabindex=".$previousTab." >
						...
						for ($i=1; $i <= $pageMax; $i++) {
							echo "
								<li class='page-item'>
									<a class='page-link' href='categories.php?category=$category&page=".$i."'>".$i."</a>
								</li>
							";
						}
						...
						echo "
								<li class='page-item ".$nextLock."'>
									<a class='page-link' href='categories.php?category=$category&page=".$nextPage."' tabindex=".$nextTab." >
